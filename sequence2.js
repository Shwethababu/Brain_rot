const sequenceData = [
    { heading: 'In 1897, British physicist J.J. Thomson conducted experiments using cathode rays and discovered that atoms contained smaller, negatively charged particles.' ,body:''},
    { heading: 'These particles, which were much smaller than atoms themselves, were later named electrons.',body:''},
    { heading: 'Thomson work showed that atoms were not indivisible, as was previously believed, but were composed of subatomic particles.',body:''},
    { heading: 'This discovery helped scientists to understand the structure of the atom and laid the groundwork for the development of atomic theory.' ,body:''},
    {heading :' The discovery of the electron marked a pivotal moment in the history of physics, leading to the development of modern atomic models.',body:''},
  ];
