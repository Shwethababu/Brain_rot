const sequenceData = [
    { heading: 'Benjamin Franklin, an American polymath, is famously known for his key experiment in 1752, which provided crucial insight into the nature of electricity.',body:''},
    { heading: 'During a thunderstorm, Franklin flew a kite with a metal key attached to the string, and the kite was struck by lightning.' ,body:''},
    { heading: 'This experiment allowed Franklin to prove that lightning was indeed a form of electricity, as he observed a spark from the key.' ,body:''},
    { heading: 'His findings supported the idea that electricity could flow through conductive materials, and he developed the concept of positive and negative electrical charges.',body:'' },
    {heading: 'Franklin experiments laid the foundation for the future study of electricity and contributed significantly to the development of electrical science.',body:''}
  ];
